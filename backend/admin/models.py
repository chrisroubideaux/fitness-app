...
class Admin(db.Model):
    ...
    phone_number = db.Column(db.String(20))
    profile_image_url = db.Column(db.String(255))     # portrait / avatar
    profile_banner_url = db.Column(db.String(255))    # wide hero-style image ✅ NEW
    ...
    activity_level = db.Column(db.String(50))
    experience_level = db.Column(db.String(50))       # Beginner / Intermediate / Advanced
    experience_years = db.Column(db.Integer)          # ✅ NEW: years of experience
    certifications = db.Column(db.Text)               # ✅ NEW: e.g. JSON or comma-separated
    specialties = db.Column(db.Text)                  # ✅ NEW: e.g. "Strength, Yoga"
    medical_conditions = db.Column(db.Text)

    # Role & permissions
    role = db.Column(db.String(50), default="trainer_admin")  # ✅ NEW
