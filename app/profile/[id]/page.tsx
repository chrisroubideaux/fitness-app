...
export default function ProfilePage() {
      ...
      try {
        ...
        const cameForCheckout =
          (typeof window !== 'undefined' &&
            localStorage.getItem('checkoutIntent') === '1') ||
        ...
        if (cameForCheckout) {
          const chosen =
            ...
            (typeof window !== 'undefined'
              ? localStorage.getItem('preselectedPlanId')
              : null);
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case 'calendar':
        return authToken ? (
          <CalendarComponent token={authToken} />
        ) : (
      ...
      case 'messages':
        return <MessagesPanel userName={user?.full_name ?? ''} />;
