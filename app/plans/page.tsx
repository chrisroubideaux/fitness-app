      ...
      <div className="layout h-100 pt-5">
        ...
        <div className="container py-5">
          <div className="text-center mb-4">
            <h1 className="fw-bold mb-1">Choose Your Plan</h1>
          ...
          {loading ? (
            <div className="text-center text-muted py-5">Loading plans…</div>
          ) : (
            <div className="row g-4 mt-5 justify-content-center">
              {plans.map((plan) => {
                const isCurrent = token ? currentPlanId === plan.id : false;
                return (
                  <div className="col-md-6 col-lg-4 mt-4" key={plan.id ?? 'free'}>
                    <MembershipCard
                      plan={plan}
                      isCurrent={isCurrent}
                      saving={saving}
