...
export default function BioAchievements({
  ...
  return (
    <section
      className="container-fluid py-5 border-20"
      style={{
          background: "linear-gradient(-45deg, #9fa2fc, #c0c4fc, #a1c4fd, #c2cbff)",
      }}
    >
      <div className="container">
       
        <div className="text-center my-5">
          <h5 className="fs-2 fw-bold">About</h5>
          <p className="fs-5 text-muted">
            Learn more about their philosophy, passion, and achievements.
          </p>
        </div>
          ...
          <div className="col-md-6 mb-4 mb-md-0">
            <div className="row g-3">
              <motion.div
                ...
                transition={{ duration: 0.5, delay: 0.1 }}
              >
                <div className="service-card text-center p-4 shadow-sm h-100 bg-white rounded">
                  <FaDumbbell className="fs-2 mb-2 social-icon" />
                  <h6 className="fw-bold">Specialties</h6>
                  <p className="small">{specialties || "N/A"}</p>
                </div>
