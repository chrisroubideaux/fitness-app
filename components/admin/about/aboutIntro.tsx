  ...
  return (
    <a
      ...
      style={{
        ...
        fontWeight: 700,
        fontSize: '0.95rem',
        background: isHovered ? hoverBackground : 'rgba(255,255,255,0.42)',
        color: isHovered ? hoverColor : '#334155',
        border: isHovered
          ? hoverBorder
  ...
  return (
    <section
      style={{
        ...
        background:
          'linear-gradient(135deg, #f7f7ff 0%, #eef4ff 34%, #ebe8ff 68%, #f7fbff 100%)',
        position: 'relative',
        overflow: 'hidden',
      }}
    >
      <div
        style={{
          ...
          inset: 0,
          background:
            'radial-gradient(circle at top right, rgba(167,139,250,0.12), transparent 30%), radial-gradient(circle at bottom left, rgba(96,165,250,0.10), transparent 28%)',
          pointerEvents: 'none',
        }}
      />
          ...
          >
            <div
              style={{
                ...
                boxShadow:
                  '0 20px 50px rgba(15,23,42,0.08), inset 0 0 0 1px rgba(255,255,255,0.24)',
              }}
            >
              <div
                style={{
