...
export default function DayViewCalendar() {
  ...
  const approvedCount = todayEvents.filter((e) => e.status === 'approved').length;
    ...
    >
      ...
      >
        <div style={{ marginBottom: '1.25rem' }}>
          ...
          >
            Manage daily client sessions, approve requests, decline conflicts,
        ...
        <div className="row g-3 mb-3">
          {[
            { label: 'Today', value: todayEvents.length, icon: <FiCalendar /> },
